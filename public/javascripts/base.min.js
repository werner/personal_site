...
else if(window.opera&&window.opera.postError){window.opera.postError(msg);}};})(jQuery);(function(){$("#form").ajaxForm(function(){return{success:$("#form").reset()};});}).call(this);(function(){$("#spain").click(function(){return window.location.replace("http://werner.heroku.com/?locale=es");});$("#usa").click(function(){return window.location.replace("http://werner.heroku.com/?locale=en");});}).call(this);